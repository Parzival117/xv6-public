...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb d0 07 00 00       	mov    $0x7d0,%ebx
        while(*s != 0){
 ...
 601:	a1 84 0a 00 00       	mov    0xa84,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 84 0a 00 00       	mov    %eax,0xa84
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6df:	73 47                	jae    728 <malloc+0x98>
    ...
    if(p == freep)
 6e1:	39 05 84 0a 00 00    	cmp    %eax,0xa84
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 84 0a 00 00    	mov    0xa84,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 737:	89 15 84 0a 00 00    	mov    %edx,0xa84
}
 ...
 757:	0a 00 00 
 75a:	c7 05 88 0a 00 00 88 	movl   $0xa88,0xa88
 761:	0a 00 00 
    base.s.size = 0;
 764:	b8 88 0a 00 00       	mov    $0xa88,%eax
